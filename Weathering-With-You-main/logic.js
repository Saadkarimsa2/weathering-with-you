...
var firstPerson = 'Saad'; // Replace with the actual name
var firstLocation = 'Delhi, India'; // Replace with the actual location

var secondPerson = 'Mehar'; // Replace with the actual name
var secondLocation = 'Lakhisarai, India';
...
var timeLeaveStamp = new Date(2020, 03, 18);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 09, 07);
